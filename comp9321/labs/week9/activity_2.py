...
if __name__ == '__main__':
    ...
    for i, true_label in enumerate(df['species']):
        true_label = true_label[0:4]
        ax.annotate(true_label, (list(df['petal_length'])[i], list(df['petal_width'])[i]), color='gray', fontSize=9,
