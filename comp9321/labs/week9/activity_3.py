...
if __name__ == '__main__':
    ...
    for i, true_label in enumerate(df['Diet']):
        true_label = "Diet_" + str(true_label)
        ax.annotate(true_label, (list(df['pre.weight'])[i], list(df['weight6weeks'])[i]), color='gray', fontSize=9,
