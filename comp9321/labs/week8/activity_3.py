...
if __name__ == '__main__':
    csv_file = 'iris.csv'
    iris_X_train, iris_y_train, iris_X_test, iris_y_test = load_iris(csv_file, split_percentage=1)
    ...
    for i, classifier in enumerate(Classifiers):
        # 5-cross validation
        accuracies = cross_val_score(classifier, iris_X_train, iris_y_train, cv=5)
